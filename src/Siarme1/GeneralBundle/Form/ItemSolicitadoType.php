...
class ItemSolicitadoType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('numero',NumberType::class, array('label'=>'Numero de Item (ID) : ','attr' => array('class' => 'form-control')))
                ->add('itemAcuerdoMarco', null, array('label'=>'Seleccione el Item Pedido:','attr' => array( 'placeholder' => "2.4.4-6818.687", 'class' => 'form-control')))
              //  ->add('ipp')
