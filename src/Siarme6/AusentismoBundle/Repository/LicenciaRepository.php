...
class LicenciaRepository extends EntityRepository
{
    ...
    # BUSCA LICENCIAS POR AÑO Y AGENTE
     /**
     *  @param integer $id del Agente
     *  
     *  @return array
     */
    public function  findByAnio($id, $anio)
    {
        $em = $this->getEntityManager();

         $consulta = $em->createQuery(
            'SELECT  l AS licencia, ar.descripcion AS articulo , SUM(l.dias) AS dias
            FROM AusentismoBundle:Licencia l  
            JOIN l.agente a
            JOIN l.documento d
            JOIN l.articulo ar
        ...
        $consulta->setParameter('id', $id)->setParameter('a', $anio);
