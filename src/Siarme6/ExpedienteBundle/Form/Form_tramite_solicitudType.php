...
class Form_tramite_solicitudType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('ccoo',TextType::class, array('label' => 'Expediente','attr' => ['placeholder' => 'EX-2022-00120295- -CAT-DPCBS#MEC', 'class' => 'form-control','autocomplete' => 'off']));
        ...
        if ($options['data']->getEstadoTramite()->getSlug() == "rectificacion") {
            $builder->add('numeroNota', TextareaType::class, array('label'=>'CCOO Rectificación: ', 'required' => false,'attr' => array('placeholder' => 'NO-2020-00524991-CAT-DPPR#MHP', 'class' => 'form-control','autocomplete' => 'off')));
          //$builder->add('texto', null, array('label' => 'Objeto: '));
        }
        if ($options['data']->getEstadoTramite()->getSlug() == "devuelto") {
           $builder->add('numeroNota', TextareaType::class, array('label'=>'CCOO Devolución: ', 'required' => false,'attr' => array('placeholder' => 'NO-2020-00524991-CAT-DPPR#MHP', 'class' => 'form-control','autocomplete' => 'off')));
          //$builder->add('texto', null, array('label' => 'Objeto: '));
        }
