...
class ExternoController extends Controller
{
    ...
    public function indexAction($anio = null)
    {
        ...
        $departamentoRm = $em->getRepository('AusentismoBundle:DepartamentoRm')->findOneBySlug("dpcbs");
         $tramites = $em->getRepository('ExpedienteBundle:Tramite')->findByDepartamentoRm($departamentoRm, $anio); 
     ...
     *
     * @Route("/{id}/show", name="credito_tramite_show")
     * @Method("GET")
     */
     ...
     * Lists all bandeja entities.
     *
     * @Route("/reporte/pre/{anio}", name="externo_reporte")
     * @Method("GET")
     */
    public function reporteAction($anio = null)
    {
        ...
        return $this->render('ExpedienteBundle:Externo:reporte.html.twig', array('anio'=>$anio,));
    }
