 ...
 * @UniqueEntity("ccoo", message="Ya existe la CCOO Nota del SAF")
...
class Tramite
{
   ...
   /**
     ...
     * @var int
     *
     * @ORM\Column(name="pf_plazo_entrega", type="decimal", precision=3, scale=2)
     */
   ...
   */
    public function __construct()
    {
        ...
        $this->pFPrecio = 83;
        $this->pFCalidadBueno = 3;
        $this->pFCalidadMuyBueno = 5;
