...
class ItemAcuerdoMarcoType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('numero',NumberType::class, array('label'=>'Numero de Item (ID) : ','attr' => array('class' => 'form-control')))
                ...
                ->add('unidadMedida')
                ->add('precio')
                ->add('cantidad',NumberType::class, array('label'=>'Cantidad Acordada: ','attr' => array('class' => 'form-control')));
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Siarme\GeneralBundle\Entity\ItemAcuerdoMarco'
        ));
    }
    ...
    {
        return 'siarme_generalbundle_itemacuerdomarco';
    }
