...
class ItemProceso
{
   ...
   /**
    ...
    /** 
     *  
     * @ORM\OneToMany(targetEntity="Siarme\GeneralBundle\Entity\ItemAcuerdoMarco", mappedBy="itemProceso") 
     * 
     */
   ...
   */
    ...
    public function addItemPedido(\Siarme\AusentismoBundle\Entity\ItemPedido $itemPedido)
    {
        ...
        if (!$this->itemPedido->contains($itemPedido)){
            $this->itemPedido[] = $itemPedido;
            $itemPedido->setItemProceso($this);
        }
        return $this;
    }
