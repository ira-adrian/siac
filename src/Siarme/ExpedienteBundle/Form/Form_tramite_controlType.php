...
class Form_tramite_controlType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('ccoo',TextareaType::class, array('label' => 'CCOO Nota del SAF: ','attr' => ['placeholder' => 'NO-2021-00194962-CAT-MTRH', 'class' => 'form-control','autocomplete' => 'off']));
        if ($options['data']->getEstadoTramite()->getSlug() == "rectificacion") {
           $builder->add('numeroComprar', TextareaType::class, array('label'=>'CCOO Rectificación: ', 'required' => false,'attr' => array('placeholder' => 'NO-2020-00524991-CAT-DPPR#MHP', 'class' => 'form-control','autocomplete' => 'off')));
          //$builder->add('texto', null, array('label' => 'Objeto: '));
        }
        if ($options['data']->getEstadoTramite()->getSlug() == "devuelto") {
           $builder->add('numeroNota', TextareaType::class, array('label'=>'CCOO No Concentra: ', 'required' => false,'attr' => array('placeholder' => 'NO-2020-00524991-CAT-DPPR#MHP', 'class' => 'form-control','autocomplete' => 'off')));
          //$builder->add('texto', null, array('label' => 'Objeto: '));
        }
